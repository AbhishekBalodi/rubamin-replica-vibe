...
export const Footer = () => {
  return (
    <footer className="bg-rubamin-dark text-white py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center mb-6">
              ...
              <span className="text-xl font-bold tracking-wider">RUBAMIN</span>
            </div>
            
            <div className="space-y-2 text-gray-300">
              <p className="font-semibold text-white">Rubamin Pvt. Ltd.</p>
              <p>Ark, 4th Floor,</p>
              <p>1 Krishna Industrial Estate,</p>
              <p>Opp. BIDC Gate, Gorwa,</p>
              <p>Vadodara, Gujarat - 390016, India</p>
            </div>
          </div>
        ...
        <div className="border-t border-gray-600 pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-6 lg:space-y-0">
            ...
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6 text-gray-300">
              <div className="flex items-center space-x-2">
                ...
                <span>+91-265-2282078</span>
              </div>
              <div className="flex items-center space-x-2">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/>
                </svg>
                <span>+91-265-2282082</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-600 text-center text-gray-400 text-sm">
            <p>© 2025 RUBAMIN (Corporate Identity No: U24299GJ1987PTC009942) | <Link to="#" className="hover:text-white transition-colors">Sitemap</Link></p>
          </div>
        </div>
      </div>
    </footer>
