        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              <h3 className="text-2xl font-bold text-rubamin-dark mb-6">Featured Story</h3>
              <div className="border-l-4 border-rubamin-green pl-6">
                <h4 className="text-xl font-bold text-rubamin-dark mb-2">
                  Rubamin Achieves Milestone in Circular Economy Implementation
                </h4>
                <p className="text-gray-600 mb-3">January 20, 2025 • Featured</p>
                <p className="text-gray-700">
                  Rubamin has successfully processed over 100,000 tons of strategic metals through 
            ...
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-rubamin-dark">Recent News & Updates</h3>
              
              {mediaItems.map((item, index) => (
                <div key={index} className="bg-white p-6 rounded-lg shadow-md border-l-4 border-rubamin-gray hover:border-rubamin-green transition-colors">
                  ...
                  <h4 className="text-lg font-bold text-rubamin-dark mb-2">{item.title}</h4>
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-12">
              <div className="bg-rubamin-green/10 p-6 rounded-lg">
                <h4 className="text-xl font-bold text-rubamin-dark mb-3">Media Contacts</h4>
                <div className="space-y-2">
                  <p><strong>Press Inquiries:</strong></p>
                  <p>media@rubamin.com</p>
                  <p>+91-265-2282078</p>
                </div>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h4 className="text-xl font-bold text-rubamin-dark mb-3">Download Resources</h4>
                <div className="space-y-3">
                  <a href="#" className="block text-rubamin-green hover:text-rubamin-dark transition-colors">
                    📄 Press Kit (PDF)
                  </a>
                  <a href="#" className="block text-rubamin-green hover:text-rubamin-dark transition-colors">
